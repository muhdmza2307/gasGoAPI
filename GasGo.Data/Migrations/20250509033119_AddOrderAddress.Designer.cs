...
namespace GasGo.Data.Migrations
{
    ...
    [Migration("20250509033119_AddOrderAddress")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GasGo.Data.Entities.Delivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GasGo.Data.Entities.DeliveryStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GasGo.Data.Entities.Delivery", b =>
                {
                    b.HasOne("GasGo.Data.Entities.UserVehicle", "DriverVehicle")
                        .WithMany("DriverDeliveries")
                        .HasForeignKey("DriverVehicleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GasGo.Data.Entities.Order", "Order")
                        .WithOne("Delivery")
                        .HasForeignKey("GasGo.Data.Entities.Delivery", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GasGo.Data.Entities.DeliveryStatus", "Status")
                        .WithMany("Deliveries")
